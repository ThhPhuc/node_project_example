export default class Helper {
    ...
    static now(days: number): Date;
    static formUrlEncoded(x: unknown): string;
    static jsonToForm(body: unknown): string;
    static random(len?: number): string;
    static random48(): string;
     ...
     * @param data any
     */
    static removeInvalidFields(data: any): any;
}
